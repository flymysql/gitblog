...
@media(max-width:720px){.hero{margin:4px 10px 0}.layout{padding:0 14px}.home-carousel{padding:0 14px}.carousel-viewport{height:180px}.hero-link{padding:5px 10px 5px 8px;gap:8px}.hero-avatar-wrap{width:44px;height:44px;min-width:44px;min-height:44px}}
</style>`;
}
