...
const NAV = [
  ...
  { id: 'comments', name: '评论管理', href: 'comments.html', icon: iconComment() },
...
function iconComment() {
  return `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H8l-5 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>`;
}
