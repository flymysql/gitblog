...
cover: assets/uploads/2026/05/用python做一个C类编译器——语法翻译器-15995704-01.webp
origin: 
---
...
输出词法分析结果  
python lexer.py  
![image](assets/uploads/2026/05/用python做一个C类编译器——语法翻译器-15995704-01.webp)

输出语法树  
python parser.py  
![image](assets/uploads/2026/05/用python做一个C类编译器——语法翻译器-15995704-02.webp)

输出四元式  
python generate.py  
![image](assets/uploads/2026/05/用python做一个C类编译器——语法翻译器-15995704-03.webp)
